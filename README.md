...
The converted data can be [found here]((https://github.com/mbrav/nydc/data) as .js files.

## Process

[data](https://github.com/mbrav/nydc/utils) - a set of utilities that where used for geocoding and parsing the data.
