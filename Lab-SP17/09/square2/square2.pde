...
void draw () {
  ...
  stroke(247,248,251);
  rect(pos.x + sin(loop/5.)*(loop%60/5+60), pos.y + cos(loop/5.)*(loop%60/5+60),  size,  size);
  stroke(42,51,54);
  rect(pos.x + sin(loop/5.)*(loop%60/5+60) + 30, pos.y + cos(loop/5.)*(loop%60/5+60) + 30,  size,  size);
