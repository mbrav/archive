...
function init() {
    ...
    var interval = 0.02;
    var middle = (data.length * interval)/2;

    for (var i = 0; i < data.length; i++) {
        geometry.vertices.push(new THREE.Vector3(i * interval - middle, data[i].accX * 10.0, 0));
        geometry2.vertices.push(new THREE.Vector3(i * interval - middle, data[i].accY * 10.0, 2));
        geometry3.vertices.push(new THREE.Vector3(i * interval - middle, data[i].accZ * 10.0, 4));
        geometry4.vertices.push(new THREE.Vector3(i * interval - middle, data[i].gyroX * 10.0, 10));
        geometry5.vertices.push(new THREE.Vector3(i * interval - middle, data[i].gyroY * 10.0, 12));
        geometry6.vertices.push(new THREE.Vector3(i * interval - middle, data[i].gyroZ * 10.0, 14));
    }
    ...
    scene.add(lines.accelerometer.z);
